...
input_partial_fname = 'all_prot_query_screened_header_50ide_50cov_positive_negative.csv'
...
output_fname = 'all_prot_query_screened_header_50ide_50cov_positive_negative_species_matched.csv'
